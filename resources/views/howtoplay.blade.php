...
<section class="howtoplay"> 
	...
	<div class="container">
		...
		<div class="col-sm-6 htpSteps" >
			...
			<div class="panel panel-primary">
				<div class="panel-heading text-center"></div>
				<div class="panel-body"><img src="/img/htp_pick.png" class="img-responsive" id="itemsImages" alt="Image" style="height: 250px"></div>
		...
		<div class="col-sm-6 htpSteps" >
			...
			<div class="panel panel-primary">
				<div class="panel-heading text-center"></div>
				<div class="panel-body"><img src="/img/htp_won.png" class="img-responsive" id="itemsImages" alt="Image" style="height: 250px"></div>
